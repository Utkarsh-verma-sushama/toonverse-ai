"use strict";
const CACHE_NAME = "uvenaro-shell-v29";
const CORE = [
  ...
  "./assets/js/launch-center.js","./assets/js/qa-suite.js","./assets/js/monetization-growth.js","./assets/js/support-community.js","./assets/js/utility-hub.js","./assets/js/camera-intelligence.js","./assets/js/coloring-studio.js","./assets/js/multimodal-runtime.js","./assets/js/memory-studio.js","./assets/js/project-store.js","./assets/js/cloud-sync.js","./assets/js/auth.js","./assets/js/ai-runtime.js","./assets/js/ai-capabilities.js",
  "./manifest.webmanifest","./assets/uvenaro-icon.svg"
];
