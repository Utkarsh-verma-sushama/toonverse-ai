"use strict";
const CACHE_NAME = "toonverse-shell-v8";
const CORE = [
  ...
  "./assets/js/project-store.js","./assets/js/cloud-sync.js","./assets/js/auth.js","./assets/js/ai-runtime.js","./assets/js/ai-capabilities.js",
