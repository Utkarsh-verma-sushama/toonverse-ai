...
const files=["assets/js/model-router.js","assets/js/agent-runtime.js","backend/worker.mjs"];
...
console.log("Verified agent guardrails, routing runtime, cloud worker and durable schema.");