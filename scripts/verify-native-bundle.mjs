...
if (!editorSource.includes("UvenaroBeforeBack") || !editorSource.includes("Discard & Start New")) throw new Error("editor.html: protected Back recovery controls are missing.");
if (!createSource.includes("UvenaroBeforeBack") || !createSource.includes("Continue your previous creation?")) throw new Error("create.html: protected Back draft recovery is missing.");
